...
;// ./src/context/SpriteContext.js

const SpriteContext = /*#__PURE__*/(0,react.createContext)();
const useSprite = () => (0,react.useContext)(SpriteContext);
const SpriteProvider = _ref => {
  let {
    children
  } = _ref;
  ...
  const [activeSprite, setActiveSprite] = (0,react.useState)(1);
    ...
    switch (type) {
      ...
      case ANIMATION_TYPES.SAY:
        ...
        const sayingTimer = duration ? setTimeout(() => {
          setSprites(prevSprites => prevSprites.map(s => s.id === sprite.id ? {
            ...s,
            saying: '',
            sayingTimer: null
          } : s));
  ...
  const executeSingleAnimation = (spriteId, animation) => {
    setSprites(prevSprites => prevSprites.map(sprite => {
      if (sprite.id === spriteId) {
        ...
        const updatedSprite = executeAnimation({
          ...sprite,
          saying: '',
          thinking: ''
        }, animation);
    ...
    for (let i = 0; i < currentSprites.length; i++) {
      for (let j = i + 1; j < currentSprites.length; j++) {
        ...
        if (distance < SPRITE_SIZE) {
          // Use SPRITE_SIZE as diameter approx.
  ...
  const updateSpritePosition = (spriteId, x, y) => {
    setSprites(sprites.map(sprite => sprite.id === spriteId ? {
      ...sprite,
      x,
      y
    } : sprite));
  ...
  const value = {
    ...
    stopAnimations,
    isPlaying,
    executeSingleAnimation,
    // Expose single execution
...
function Sidebar() {
  const {
    ...
    executeSingleAnimation,
    activeSprite
  } = useSprite(); // Use executeSingleAnimation
  ...
  const blocks = [{
    ...
    items: [{
      ...
      type: ANIMATION_TYPES.THINK,
      text: "Think Hmm... for 2 secs",
      color: "bg-purple-500",
      onClick: () => handleBlockClick({
        type: ANIMATION_TYPES.THINK,
        value: 'Hmm...',
  ...
  return (
    ...
    react.createElement("div", {
      className: "w-72 flex-none h-full overflow-y-auto flex flex-col items-start p-3 bg-white border-r border-gray-300 space-y-4"
    }, blocks.map(section => /*#__PURE__*/react.createElement("div", {
      key: section.section,
      className: "w-full"
    }, /*#__PURE__*/react.createElement("div", {
      className: "font-bold text-xs text-gray-500 uppercase tracking-wider mb-1"
    }, section.section), section.items.map((block, idx) => /*#__PURE__*/react.createElement(DraggableBlock, _extends({
      key: block.text + idx
    }, block))))))
  );
}
;// ./src/components/AnimationBlock.js

const AnimationBlock = _ref => {
  let {
    animation,
    index,
    updateAnimation,
  ...
  const [editValues, setEditValues] = (0,react.useState)({
    ...animation
  });
  ...
  switch (animation.type) {
    case ANIMATION_TYPES.MOVE:
      text = isEditing ? /*#__PURE__*/react.createElement(react.Fragment, null, "Move ", /*#__PURE__*/react.createElement("input", {
        type: "number",
        name: "value",
        value: editValues.value,
        onChange: handleInputChange,
        className: "w-10 mx-1 text-black rounded px-1"
      }), " steps") : `Move ${animation.value} steps`;
      color = "bg-blue-500";
      break;
    case ANIMATION_TYPES.TURN:
      text = isEditing ? /*#__PURE__*/react.createElement(react.Fragment, null, "Turn ", animation.value >= 0 ? "↻" : "↺", " ", /*#__PURE__*/react.createElement("input", {
        type: "number",
        name: "value",
        value: Math.abs(editValues.value),
        onChange: handleInputChange,
        className: "w-10 mx-1 text-black rounded px-1"
      }), " degrees") : `Turn ${animation.value >= 0 ? "↻" : "↺"} ${Math.abs(animation.value)} degrees`;
      color = "bg-blue-500";
      break;
    case ANIMATION_TYPES.GOTO:
      text = isEditing ? /*#__PURE__*/react.createElement(react.Fragment, null, "Go to x: ", /*#__PURE__*/react.createElement("input", {
        type: "number",
        name: "x",
        value: editValues.x,
        onChange: handleInputChange,
        ...
        value: editValues.y,
        onChange: handleInputChange,
        className: "w-10 ml-1 text-black rounded px-1"
      })) : `Go to x: ${animation.x} y: ${animation.y}`;
      color = "bg-blue-500";
      break;
    case ANIMATION_TYPES.SAY:
      text = isEditing ? /*#__PURE__*/react.createElement(react.Fragment, null, "Say ", /*#__PURE__*/react.createElement("input", {
        type: "text",
        name: "value",
        value: editValues.value,
        onChange: handleInputChange,
        className: "mx-1 text-black rounded px-1 flex-grow"
        ...
        onChange: handleInputChange,
        className: "w-10 ml-1 text-black rounded px-1"
      }), " secs") : `Say ${animation.value} for ${animation.duration} secs`;
      color = "bg-purple-500";
      break;
    case ANIMATION_TYPES.THINK:
      text = isEditing ? /*#__PURE__*/react.createElement(react.Fragment, null, "Think ", /*#__PURE__*/react.createElement("input", {
        type: "text",
        name: "value",
        value: editValues.value,
        onChange: handleInputChange,
        ...
        onChange: handleInputChange,
        className: "w-10 ml-1 text-black rounded px-1"
      }), " secs") : `Think ${animation.value} for ${animation.duration} secs`;
      color = "bg-purple-500";
      break;
    case ANIMATION_TYPES.REPEAT:
      text = isEditing ? /*#__PURE__*/react.createElement(react.Fragment, null, "Repeat ", /*#__PURE__*/react.createElement("input", {
        type: "number",
        name: "count",
        value: editValues.count,
        onChange: handleInputChange,
        className: "w-10 mx-1 text-black rounded px-1"
      }), " times") : `Repeat ${animation.count} times`;
      color = "bg-yellow-500";
      break;
    default:
  ...
  }, text), !isEditing ? /*#__PURE__*/react.createElement("button", {
  ...
  }, "X"))), animation.type === ANIMATION_TYPES.REPEAT && /*#__PURE__*/react.createElement("div", {
    className: "ml-4 mt-1 border-l-2 border-yellow-300 pl-2"
  }, /*#__PURE__*/react.createElement("span", {
    className: "text-xs italic text-yellow-200"
  }, "Nested blocks go here")));
};
/* harmony default export */ const components_AnimationBlock = (AnimationBlock);
...
function PreviewArea() {
  const {
    sprites,
    updateSpritePosition
  } = useSprite(); // Add updateSpritePosition
  const [collisionMessage, setCollisionMessage] = (0,react.useState)("");
  const prevSpritesRef = (0,react.useRef)([]);
  (0,react.useEffect)(() => {
    ...
    if (prevSpritesRef.current.length && sprites.length > 1) {
      for (let i = 0; i < sprites.length; i++) {
        ...
        if (prev && curr && prev.animations !== curr.animations && prev.animations.length > 0 && curr.animations.length > 0 && prev.animations[0] !== curr.animations[0]) {
          setCollisionMessage(`Collision! ${prev.name} and ${curr.name} swapped animations.`);
          setTimeout(() => setCollisionMessage(""), 1500);
          break;
        }
      }
    }
    prevSpritesRef.current = sprites.map(s => ({
      ...s
    }));
  }, [sprites]);
  ...
  }, collisionMessage && /*#__PURE__*/react.createElement("div", {
    className: "absolute top-2 left-1/2 transform -translate-x-1/2 bg-yellow-400 text-black px-4 py-2 rounded shadow-lg z-50 animate-pulse"
  }, collisionMessage), sprites.map(sprite => /*#__PURE__*/react.createElement("div", {
    key: sprite.id,
    draggable: true // Make the sprite draggable
    ,
  ...
  }, " ", /*#__PURE__*/react.createElement(CatSprite, null)), sprite.saying && /*#__PURE__*/react.createElement("div", {
    className: "absolute bottom-full mb-4 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white text-sm rounded py-2 px-3 whitespace-nowrap shadow-lg z-10 pointer-events-none"
  }, " ", sprite.saying, /*#__PURE__*/react.createElement("div", {
    className: "absolute left-1/2 transform -translate-x-1/2 -bottom-1 w-0 h-0 border-l-5 border-l-transparent border-r-5 border-r-transparent border-t-5 border-t-blue-600"
  })), sprite.thinking && /*#__PURE__*/react.createElement("div", {
    className: "absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 bg-gray-300 text-black text-xs rounded-full py-1 px-3 shadow pointer-events-none"
  }, " ", sprite.thinking)))));
}
;// ./src/components/CostumesArea.js
 // Import useState
 // Import Icon for toolbar buttons
 // Import CatSprite for thumbnail
...
const CostumesArea = () => {
  ...
  const [selectedCostumeId, setSelectedCostumeId] = (0,react.useState)(costumes[0]?.id); // State for selected costume ID
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "flex flex-1 h-full overflow-hidden bg-gray-100"
  }, /*#__PURE__*/react.createElement("div", {
    className: "w-24 flex-none h-full overflow-y-auto p-2 border-r border-gray-300 bg-white"
  }, costumes.map((costume, index) => /*#__PURE__*/react.createElement("div", {
    key: costume.id,
  ...
  }, /*#__PURE__*/react.createElement("span", null, index + 1), /*#__PURE__*/react.createElement("button", {
    className: "text-gray-400 hover:text-red-500"
  }, "x")), /*#__PURE__*/react.createElement("div", {
    className: "w-16 h-16 mx-auto flex items-center justify-center bg-gray-200 rounded overflow-hidden"
  }, /*#__PURE__*/react.createElement("div", {
    style: {
      transform: 'scale(0.3)',
      transformOrigin: 'center'
    }
  }, /*#__PURE__*/react.createElement(CatSprite, null))), /*#__PURE__*/react.createElement("div", {
    className: "text-center text-xs mt-1"
  }, costume.name), /*#__PURE__*/react.createElement("div", {
    className: "text-center text-xs text-gray-500"
  }, costume.width, " x ", costume.height))), /*#__PURE__*/react.createElement("button", {
    className: "w-full mt-2 p-2 text-center text-xs bg-blue-500 text-white rounded hover:bg-blue-600"
  }, "Add Costume")), /*#__PURE__*/react.createElement("div", {
    className: "flex-1 flex flex-col h-full overflow-hidden"
  }, /*#__PURE__*/react.createElement("div", {
    className: "flex items-center justify-center p-1 space-x-2 bg-gray-200 border-b border-gray-300"
  }, /*#__PURE__*/react.createElement("button", {
    ...
    className: "w-12 flex-none flex flex-col items-center p-1 space-y-1 bg-gray-200 border-r border-gray-300"
  }, /*#__PURE__*/react.createElement("button", {
    className: "p-1 hover:bg-gray-300 rounded"
  }, /*#__PURE__*/react.createElement(Icon, {
    name: "tool-select",
    ...
    className: "flex-1 flex items-center justify-center bg-white relative overflow-auto",
    style: {
  ...
  }, selectedCostume?.name === 'costume1' ? /*#__PURE__*/react.createElement(CatSprite, null) : /*#__PURE__*/react.createElement("div", {
    className: "w-16 h-16 bg-red-200 rounded"
  }, "Costume 2 Placeholder")), /*#__PURE__*/react.createElement("div", {
    className: "absolute bottom-2 right-2 flex items-center bg-gray-200 rounded p-1"
  }, /*#__PURE__*/react.createElement("button", {
    className: "px-1"
  }, /*#__PURE__*/react.createElement(Icon, {
    name: "zoom-out",
    ...
    className: "flex items-center p-1 space-x-2 bg-gray-200 border-t border-gray-300"
  }, /*#__PURE__*/react.createElement("span", {
    className: "text-xs font-semibold ml-2"
  }, "Costume: ", selectedCostume?.name || 'None'), /*#__PURE__*/react.createElement("div", {
    className: "flex-grow"
  }), " ", /*#__PURE__*/react.createElement("label", {
    className: "text-xs flex items-center"
  }, "Fill: ", /*#__PURE__*/react.createElement("button", {
    className: "w-5 h-5 bg-purple-500 border border-gray-400 rounded ml-1"
  })), /*#__PURE__*/react.createElement("label", {
    className: "text-xs flex items-center"
  }, "Outline: ", /*#__PURE__*/react.createElement("input", {
    type: "number",
    defaultValue: "4",
    className: "w-8 h-5 text-xs border rounded px-1 ml-1"
  })), /*#__PURE__*/react.createElement("button", {
    className: "text-xs px-2 py-0.5 bg-blue-500 text-white rounded hover:bg-blue-600"
  }, "Convert to Bitmap"))));
};
/* harmony default export */ const components_CostumesArea = (CostumesArea);
;// ./src/components/SoundsArea.js
 // Import useState, useEffect
 // Import Icon for toolbar buttons

const SoundsArea = () => {
  const audioRef = (0,react.useRef)(null);
  const [audioContext, setAudioContext] = (0,react.useState)(null);
  const [audioSource, setAudioSource] = (0,react.useState)(null);
  const [gainNode, setGainNode] = (0,react.useState)(null);
  const [isPlaying, setIsPlaying] = (0,react.useState)(false);
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "w-24 flex-none h-full overflow-y-auto p-2 border-r border-gray-300 bg-white"
  }, sounds.map((sound, index) => /*#__PURE__*/react.createElement("div", {
    key: sound.id,
    ...
    className: "w-16 h-16 mx-auto flex items-center justify-center bg-purple-200 rounded"
  }, /*#__PURE__*/react.createElement(Icon, {
    name: "volume-full",
    size: 32,
    ...
    className: "text-center text-xs mt-1"
  }, sound.name), /*#__PURE__*/react.createElement("div", {
    className: "text-center text-xs text-gray-500"
  }, sound.duration, "s"))), /*#__PURE__*/react.createElement("button", {
    className: "w-full mt-2 p-2 text-center text-xs bg-blue-500 text-white rounded hover:bg-blue-600"
  }, "Add Sound")), /*#__PURE__*/react.createElement("div", {
    className: "flex-1 flex flex-col h-full overflow-hidden bg-white p-4 items-center"
  }, /*#__PURE__*/react.createElement("div", {
  ...
  }, "Sound: ", selectedSound.name)), /*#__PURE__*/react.createElement("div", {
    ...
    className: "w-full flex-grow flex items-center justify-center mb-4"
  }, /*#__PURE__*/react.createElement("div", {
    className: "w-11/12 h-32 bg-purple-200 rounded flex items-center justify-center"
  }, /*#__PURE__*/react.createElement("span", {
    className: "text-purple-600 italic"
  }, "Sound Waveform Placeholder"))), /*#__PURE__*/react.createElement("div", {
    ...
    className: "text-xs p-1 hover:bg-gray-200 rounded"
  }, "Louder"), /*#__PURE__*/react.createElement("button", {
    onClick: () => changeVolume(-0.2),
    className: "text-xs p-1 hover:bg-gray-200 rounded"
  }, "Softer"), /*#__PURE__*/react.createElement("button", {
    onClick: toggleMute,
    className: `text-xs p-1 hover:bg-gray-200 rounded ${volume === 0 ? 'bg-gray-300' : ''}`
  }, "Mute"), /*#__PURE__*/react.createElement("button", {
    className: "text-xs p-1 hover:bg-gray-200 rounded opacity-50 cursor-not-allowed"
  }, "Fade in"), /*#__PURE__*/react.createElement("button", {
    className: "text-xs p-1 hover:bg-gray-200 rounded opacity-50 cursor-not-allowed"
  }, "Fade out"), /*#__PURE__*/react.createElement("button", {
    className: "text-xs p-1 hover:bg-gray-200 rounded opacity-50 cursor-not-allowed"
  }, "Reverse"), /*#__PURE__*/react.createElement("button", {
    className: "text-xs p-1 hover:bg-gray-200 rounded opacity-50 cursor-not-allowed"
  }, "Robot"))), /*#__PURE__*/react.createElement("audio", {
    ref: audioRef,
    src: soundFilePath,
    preload: "auto",
...
/* harmony default export */ const components_SoundsArea = (SoundsArea);
;// ./src/components/SpriteList.js


 // Assuming a small preview
...
function SpriteList() {
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "flex flex-col items-center p-2 bg-gray-100 border-t border-gray-300 h-full"
  }, /*#__PURE__*/react.createElement("h3", {
    className: "text-sm font-semibold mb-2"
  }, "Sprites"), /*#__PURE__*/react.createElement("input", {
    type: "text",
    ...
    className: "flex-grow overflow-y-auto space-y-2 mb-2 w-full flex flex-col items-center"
  }, filteredSprites.map(sprite => /*#__PURE__*/react.createElement("button", {
    key: sprite.id,
    ...
    className: "w-12 h-12 bg-white rounded flex items-center justify-center overflow-hidden p-1"
  }, /*#__PURE__*/react.createElement("div", {
    style: {
      transform: 'scale(0.4)',
      transformOrigin: 'top left'
    }
  }, /*#__PURE__*/react.createElement(CatSprite, null))), /*#__PURE__*/react.createElement("p", {
...
function MidArea() {
  ...
  const [activeTab, setActiveTab] = (0,react.useState)('code'); // State for active tab
  ...
  const CodeArea = () => /*#__PURE__*/react.createElement("div", {
    ...
    className: "space-y-1"
  }, currentSprite && currentSprite.animations.length > 0 ? currentSprite.animations.map((animation, index) => /*#__PURE__*/react.createElement(components_AnimationBlock, {
    key: index,
    animation: animation,
    index: index,
    ...
    className: "text-gray-400 italic text-center mt-10"
  }, "Drop blocks here to build a script!")));
  return /*#__PURE__*/react.createElement("div", {
  ...
  }, "Costumes"), /*#__PURE__*/react.createElement("button", {
    onClick: () => setActiveTab('sounds'),
    className: `px-4 py-2 ${activeTab === 'sounds' ? 'bg-white text-blue-600 font-semibold' : 'text-gray-600 hover:bg-gray-200'}`
  }, "Sounds")), activeTab === 'code' && /*#__PURE__*/react.createElement(CodeArea, null), activeTab === 'costumes' && /*#__PURE__*/react.createElement(components_CostumesArea, null), activeTab === 'sounds' && /*#__PURE__*/react.createElement(components_SoundsArea, null)), /*#__PURE__*/react.createElement("div", {
    className: "w-[480px] flex-none h-full flex flex-col bg-gray-100 border-l border-gray-300"
  }, " // Increased width", /*#__PURE__*/react.createElement("div", {
    className: "flex justify-end items-center p-2 space-x-2 bg-gray-200 border-b border-gray-300"
  }, /*#__PURE__*/react.createElement("button", {
    onClick: playAnimations,
    disabled: isPlaying,
    className: "p-1 rounded bg-green-500 hover:bg-green-600 disabled:opacity-50"
  }, /*#__PURE__*/react.createElement(Icon, {
    name: "flag",
    size: 20,
    ...
    disabled: !isPlaying,
    className: "p-1 rounded bg-red-500 hover:bg-red-600 disabled:opacity-50"
  }, /*#__PURE__*/react.createElement(Icon, {
    name: "stop",
    size: 20,
    className: "text-white"
  }))), /*#__PURE__*/react.createElement("div", {
    className: "flex-grow relative bg-white m-2 border border-gray-400 rounded overflow-hidden"
  }, /*#__PURE__*/react.createElement(PreviewArea, null)), /*#__PURE__*/react.createElement("div", {
    className: "p-2 border-t border-gray-300 bg-gray-50 h-48 overflow-y-auto"
  }, /*#__PURE__*/react.createElement("div", {
    className: "font-semibold mb-2"
  }, "Sprite"), currentSpriteInfo && /*#__PURE__*/react.createElement("div", {
    className: "grid grid-cols-2 gap-x-2 gap-y-1 text-sm mb-3"
  }, /*#__PURE__*/react.createElement("span", null, "Sprite:"), /*#__PURE__*/react.createElement("span", null, currentSpriteInfo.name), /*#__PURE__*/react.createElement("label", {
    htmlFor: "sprite-x"
  }, "x:"), /*#__PURE__*/react.createElement("input", {
    id: "sprite-x",
    type: "number",
    value: Math.round(currentSpriteInfo.x),
    readOnly: true,
    ...
    id: "sprite-y",
    type: "number",
    value: Math.round(currentSpriteInfo.y),
    readOnly: true,
    className: "border rounded px-1 w-16"
  }), /*#__PURE__*/react.createElement("span", null, "Show:"), /*#__PURE__*/react.createElement("span", null, "\uD83D\uDC41\uFE0F"), " ", /*#__PURE__*/react.createElement("label", {
    htmlFor: "sprite-size"
    ...
    id: "sprite-dir",
    type: "number",
    value: Math.round(currentSpriteInfo.direction),
    readOnly: true,
    className: "border rounded px-1 w-16"
  })), /*#__PURE__*/react.createElement("div", {
    className: "border-t pt-2 h-[calc(100%-80px)]"
  }, " ", /*#__PURE__*/react.createElement(SpriteList, null))), /*#__PURE__*/react.createElement("div", {
    className: "p-2 border-t border-gray-300 bg-gray-50 h-24"
  }, /*#__PURE__*/react.createElement("div", {
...
const TopBar = () => {
  return /*#__PURE__*/react.createElement("div", {
    className: "w-full h-12 bg-purple-600 text-white flex items-center justify-between px-4 shadow-md"
  }, /*#__PURE__*/react.createElement("div", {
    className: "flex items-center space-x-4"
  }, /*#__PURE__*/react.createElement("span", {
    className: "font-bold text-lg"
  }, "SCRATCH"), /*#__PURE__*/react.createElement("button", {
  ...
  }, "Join Scratch"), /*#__PURE__*/react.createElement("button", {
...
function App() {
  return /*#__PURE__*/react.createElement("div", {
    className: "flex flex-col h-screen w-screen bg-gray-50"
  }, " ", /*#__PURE__*/react.createElement(components_TopBar, null), " ", /*#__PURE__*/react.createElement("div", {
    className: "flex flex-1 min-h-0"
  }, " ", /*#__PURE__*/react.createElement(Sidebar, null), /*#__PURE__*/react.createElement(MidArea, null)));
}
;// ./src/index.js
...
console.log("hi");
react_dom.render(/*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(SpriteProvider, null, " ", /*#__PURE__*/react.createElement(App, null))), document.getElementById("root"));
/******/ })()
;